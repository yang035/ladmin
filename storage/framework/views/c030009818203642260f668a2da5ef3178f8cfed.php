    ...
    <div class="box-body">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php $__currentLoopData = $opencities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opencity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr data-id="<?php echo e($opencity->id); ?>">
                        <td><?php echo e($opencity->id); ?></td>
                        <td><?php echo e($opencity->name); ?></td>
                        <td><a target="tab" href="<?php echo e($opencity->id); ?>">查看</a></td>
                        <td><a target="tab" href="<?php echo e($opencity->id); ?>">查看</a></td>
                        <td><a target="tab" href="<?php echo e($opencity->id); ?>">查看</a></td>
                        <td><?php echo e($opencity->code); ?></td>
                        <td><?php echo e($opencity->fc); ?></td>
                        <td><?php echo e($opencity->status); ?></td>
                    </tr>
